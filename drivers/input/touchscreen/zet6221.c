...
static int gpio_int_hdle_read = 3; //zhongwei changed
...
#define MJ5_TS_NAME	ZET_TS_ID_NAME //zhongwei changed device name
...
struct zet6221_tsdrv {
	...
	struct workqueue_struct *ts_workqueue1; //zhongwei write_cmd
...
/**
 *
 * get gpio value zhongwei add 03/02/2012
 *
**/
__u32 get_gpio_value()
{
	//Jack.wu 03/02/2012 for debug INT
...
/*
 *
 * zhongwei add for write charge_mode_enable cmd 05/03/2012
 *
 *
 */
void ts_write_charge_enable_cmd()
